  ...
  return (
    <Card className="p-0">
      ...
      <div className="overflow-x-auto">
        <div className={recordListGridClassName + ' border-b border-white/10 bg-slate-950/50 px-5 py-3'}>
        ...
        <div>
          {Array.from({ length: rows }).map((_, index) => (
            <div key={index} className={recordListGridClassName + ' border-b border-white/10 px-5 py-4'}>
              ...
              <div className="ml-auto h-10 w-10 rounded-xl bg-white/10" />
            </div>
          ))}
        </div>
      </div>
    ...
    return (
      <Card className="p-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-5 inline-flex rounded-full border border-cyan-300/20 bg-cyan-300/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-cyan-200">
            Shared CRM work queue
          </div>
          <h3 className="mt-5 font-display text-3xl text-white">{emptyState.title}</h3>
  ...
  return (
    <Card className="p-0">
      <div className="flex flex-col gap-4 border-b border-white/10 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <div className="text-xs uppercase tracking-[0.24em] text-cyan-200">{formatCrmLabel(crmType)} records desk</div>
          <h3 className="mt-2 font-display text-2xl text-white">Compact queue view</h3>
        </div>
      ...
      <div className="overflow-x-auto">
        <div className={recordListGridClassName + ' border-b border-white/10 bg-slate-950/50 px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500'}>
          <div>Lead</div>
          <div>Phone</div>
          <div>Type</div>
          <div>Stage</div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <label className="flex items-center gap-2 text-sm text-slate-400">
            ...
            <select
              ...
              className="h-10 rounded-2xl border border-white/10 bg-slate-950/70 px-3 text-sm text-white"
            >
              {[10, 20, 25].map((option) => (
