    ...
    <Card className="p-5">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs uppercase tracking-[0.28em] text-cyan-200">Filters</div>
            <div className="mt-2 text-sm text-slate-400">Slice the inbound queue by outcome, review state, agent, and number.</div>
          </div>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
          <label className="space-y-2 text-sm text-slate-300">
            ...
            <select
              ...
              className="h-11 w-full rounded-2xl border border-white/10 bg-slate-950/80 px-4 text-white outline-none"
            >
